...
runPro = Button(profilePage, text='Run', command=(lambda: sf.automatic_control(profilePage, profileEntries, varList, varList2, positionSliderList, positionPro)))
...
varList2 = [ratioSpecStart, ratioSpecCal, ratioSpecProfile]
